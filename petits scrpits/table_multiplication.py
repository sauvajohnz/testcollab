...
def tirets(nombre_tirets): #On crée une fonction qui une fois appellée affiche un certain nombre de tirets
...
while i < table_limit : # On calcule en affichant sur la console les résultats
	...
	resultat_longueur = math.log10(table*(i+1)) + 1 # On recupere la taille du résultat
	print("")
